...
static PyObject* sym(PyObject *self, PyObject *args) {
    ...
    sym_matrix = sym();
    /*
     * TODO: change sym so it matches the logic of no global vectors_array
     */
...
static PyObject* norm(PyObject *self, PyObject *args) {
    ...
    norm_matrix = norm(ddg_matrix, sym_matrix);
    free_memory_of_matrix(sym_matrix, vectors_count);
    free_memory_of_matrix(ddg_matrix, vectors_count);
    if (norm_matrix == NULL) {
        return NULL;
...
static PyObject* symnmf(PyObject *self, PyObject *args) {
    ...
    decomposition_matrix_H = symnmf(initial_decomposition_matrix_H, norm_matrix);
    free_memory_of_matrix(initial_decomposition_matrix_H, vectors_count);
    free_memory_of_matrix(norm_matrix, vectors_count);
