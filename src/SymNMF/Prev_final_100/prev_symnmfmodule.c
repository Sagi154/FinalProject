...
/* ------------ CPython API ------------ */
static PyMethodDef prev_symnmfMethods[] = {
        {"symnmf",
                (PyCFunction) symnmf,
                     METH_VARARGS,
...
static struct PyModuleDef prev_symnmfmodule = {
...
PyMODINIT_FUNC PyInit_prev_symnmfmodule(void) {
    return PyModule_Create(&prev_symnmfmodule);
}
